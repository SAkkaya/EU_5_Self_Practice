...
public class RemoveDuplicates_InterviewQ_Muhtar {
...
/*
 * Write a program that can remove duplciated characters from a string ex: str =
 * "aaaabbbbbbcccccccccdddd" output: abcd
 */
