...
public class Microsoft { // Microsoft HAS A Employee
	...
	public static void main(String[] args) {
		...
		Employee[] testers = { new Employee("Kunduz", "SDET", 123, 150000), new Employee("Zina", "QE", 321, 170000),
				new Employee("Murat", "QA", 789, 105000), new Employee("Bunyamin", "SDET", 852, 85000)};
		...
		for (Employee each : testers) { 
			...
			if (each.salary > maxSalary) {  // each-->object  salary--> instance variable
