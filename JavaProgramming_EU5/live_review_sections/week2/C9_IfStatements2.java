 ...
 * write a program that can calculate the grade. 
	...
	4. if grade is smaller then 60 output "Fail" 
		...
		ex: score = 75 output: Good HINT: you will need && logic
 */
		int score = 85;
...
//			String status;
//			status=score>=0 && score<=100 ? (score>=90 ? "Excellent" : score>=70 ? "Good" : score>=60 ? "Pass" : "fail") : "invalid";
