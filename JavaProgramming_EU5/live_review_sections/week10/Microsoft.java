...
public class Microsoft {
	...
	public static void main(String[] args) {
        ...
        scrum1.addTester(tester1); // +1 tester
        scrum1.addTester(testers); // +2 testers
        System.out.println("Total Number of testers : " + scrum1.testers.size()); //Total Number of testers : 3
        
        
        scrum1.addDeveloper(developer1);// + 1 developer
        scrum1.addDeveloper(developers); // + 3 developers
        System.out.println("Total Number of Developers : " + scrum1.developers.size()); //Total Number of Developers : 4
        
        System.out.println(scrum1); //week10.Scrumteam@15db9742  almamak icin scrumteam icine toString methodu ekledik cikti alabilmek icin
        
        scrum1.removeTester(123);
        
        System.out.println(scrum1.testers.size());
