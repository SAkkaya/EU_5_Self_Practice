...
public class Scrumteam {
	...
	public String toString() {  // prints the Po , SM, BA, total number of testers and total number of developers
		return "Scrumteam [PO=" + PO + ", BA=" + BA + ", SM=" + SM + ", testers=" + testers.size() + ", developers="
				+ developers.size() + "]";  // size () methodu ekledik dev ve tester lara
	}
