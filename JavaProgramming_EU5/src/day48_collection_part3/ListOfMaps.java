...
public class ListOfMaps {
	...
	public static void main(String[] args) {
		...
		System.out.println(employees.get(1));  //{Salary=80000, EmpID=124, JobTitle=Dev, EmpName=Mike}
		...
		//
		int totalSalary = 0;
		for(Map<String,String> emp : employees) {     //employees--> List adi  ==>List<Map<String,String>> employees
			
			//System.out.println(emp.get("JobTitle"));  //SDET, Dev
