...
public class LoopMap {
	...
	public static void main(String[] args) {
		...
		Map<String,String> dataMap = new HashMap<>();         //Map Interface ==> interface den object yaratamayiz o yuzde n sagtarafda class dan object yartamak icin poliyorphisim kukkaniriz, Interface de ki methodu kullanbilmek icin  
		...
		for(String key : dataMap.keySet() ) {
			System.out.println(key);   // sira ile vermez karisik verir
		}
		...
		for(String key : dataMap.keySet()) {
			System.out.println(key +"|"+dataMap.get(key)); //     dataMap.get(key) => values u veris
		}
