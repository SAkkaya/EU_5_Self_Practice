...
public class C8_Bestbuy_CellPhoneObjects {

	public static void main(String[] args) {

		C3_CellPhone cell1 = new C3_CellPhone();

		System.out.println(cell1.brand); // null -- default String
		System.out.println(cell1.screenSize); // 0.0 --> double default data type i ===> 0.0
		...
		C3_CellPhone cell2 = new C3_CellPhone();
