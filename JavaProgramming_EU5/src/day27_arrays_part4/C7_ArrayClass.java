...
public class C7_ArrayClass {
	...
	public static void main(String[] args) {
		...
		//toString()
				...
				System.out.println(Arrays.binarySearch(numX, 5)); //-2   //(-(insertionPoint)-1)   4, ile 6 nin arasina girecekti index no 1 ;
																			// yani==>insertionPoint=1, (-(1)-1; =-2
				
				System.out.println(Arrays.binarySearch(numX, 15)); //-5   //(-(insertionPoint)-1) ==> (-(4)-1)==>-5
